...
This plugin does not work alone. It is originally created for WP Job Manager, so you have to install WP Job Manager before.
...
Setting page is under Job Listings Menu
...
1. Upload `cfwjm.php` to the `/wp-content/plugins/` directory
