...
<div class="form-wrap">    
    ...
    <form method="POST" action="<?php echo esc_html( admin_url( 'admin-post.php' ) ); ?>">
        ...
        <div class="form-field">
            ...
            <select name="tag-required" style="min-width: 95%;">
        ...
        <div class="form-field">
            ...
            <input name="tag-description" type="text">
        </div>
        <div class="form-field">
            <label for="tag-cfwjm-tag"><?php echo __("Cfwjm Tag", $this->plugin_name); ?></label>
            <input name="tag-cfwjm-tag" type="text">
        </div>
        <?php
            submit_button( esc_attr__( 'Add Field', $this->plugin_name ), 'primary', 'submit-name', TRUE );
        ?>
    </form>
</div>